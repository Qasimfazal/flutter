class NetworkEndpoints {
  ...
  static const String ADD_REMOVE_FROM_FAVOURITES = BASE_URL+"api/toggle-favourite";
  static const String ADD_RESEARCHER_PROGRESS1= BASE_URL+"api/researcher-inprogress";
